  (function() {
    ...
    firebase.auth().onAuthStateChanged(firebaseUser => {
      ...
      if(firebaseUser){
      	...
      	var friendsUidRef = dbRefObject.child(firebase.auth().currentUser.uid).child('friends');
        ...
        friendsUidRef.on('child_added', firendsUidSnap => {

        	console.log(firendsUidSnap.key);

        	var friendsRepoKey = dbRefObject.child(firendsUidSnap.key).child('repositories');

        	friendsRepoKey.on('child_added', userRepoKeySnap => {
